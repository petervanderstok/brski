...
void bignum_powermod( struct bn *x, struct bn *n, struct bn *p, struct bn *res); /* modulo power -- res = x^n mod p */
void bignum_squaremod(struct bn *y, struct bn *p, struct bn *x);                 /* modulo square root -- (x*x) mod p = y mod p */
